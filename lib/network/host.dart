class Hosting {
  ...
  static final String getWaitingTours = host + "tour/waiting";
  static final String getPendingTours =
      host + "tour/allcollaboratorpendingtours";
  static final String registerTour = host + "tour/register";
  ...
  static final String changeUserPassword =
      host + "collaborator/password/changeuserpassword";
}
